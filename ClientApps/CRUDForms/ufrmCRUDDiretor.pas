...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TDiretor);
    ...
    procedure InitializeNewObject(ANewObject: TDiretor);
    procedure AfterInsert(AObject: TDiretor);
    procedure BeforeDelete(AObject: TDiretor);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TDiretor);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     protected
        FForm: TfrmCRUDDiretor;
        FPOIDToSelect: Integer;
     public
        property Form: TfrmCRUDDiretor read FForm write FForm;
...
var
   frmCRUDDiretor: TfrmCRUDDiretor;
...
//************************************************************************
//* TfrmCRUDDiretor.FormCreate
//************************************************************************
procedure TfrmCRUDDiretor.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDDiretor.FormActivate
//************************************************************************
procedure TfrmCRUDDiretor.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDDiretor.FormDestroy
//************************************************************************
procedure TfrmCRUDDiretor.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDDiretor.FormResize
//************************************************************************
procedure TfrmCRUDDiretor.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.FormClose
//************************************************************************
procedure TfrmCRUDDiretor.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDDiretor.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDDiretor.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDDiretor.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDDiretor.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.cmdInsertClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdInsertClick(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDDiretor.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdDeleteClick(Sender: TObject);
var
   ObjectToDelete: TDiretor;
   CanDelete: Boolean;
   Reason: string;
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TDiretor.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TDiretor;
...
//************************************************************************
//* TfrmCRUDDiretor.cmdEditClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdEditClick(Sender: TObject);
//$$** SECTION: EDITBUTTONCLICK_FULLIMPL
var
   ObjectToEdit: TDiretor;
   DataForm: TP2SBFClientDataForm;
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TDiretor.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TDiretor;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TDiretor then begin
...
//************************************************************************
//* TfrmCRUDDiretor.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDDiretor.cmdListClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDDiretor.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDDiretor.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDDiretor.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDDiretor.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDDiretor.cmdSearchClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDDiretor',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDDiretor.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDDiretor.cmdCustomButtonsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataDblClick
//************************************************************************
procedure TfrmCRUDDiretor.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDDiretor.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDDiretor.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDDiretor.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDDiretor.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDDiretor.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDDiretor.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDDiretor.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDDiretor.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDDiretor.InitializeAvailableColumns;
...
begin
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='DataNascimento';
   AvailableColumn.PropertyDescription:='Data de Nascimento';
...
//************************************************************************
//* TfrmCRUDDiretor.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDDiretor.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDDiretor.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDDiretor.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDDiretor.SetupGridColumns
//************************************************************************
procedure TfrmCRUDDiretor.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDDiretor.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDDiretor.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDDiretor.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDDiretor.FillGridRow
//************************************************************************
procedure TfrmCRUDDiretor.FillGridRow(ARow: Integer; AObject: TDiretor);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//$$** SECTION: FILL_GRID_COLUMNS
         ...
         end else if AvailableColumn.PropertyName='DataNascimento' then begin
            if AObject.DataNascimento<>0.0 then begin
               grdData.Cells[c,ARow]:=FormatDateTime('dd/mm/yyyy',AObject.DataNascimento);
            end else begin
...
//************************************************************************
//* TfrmCRUDDiretor.ClearGridRow
//************************************************************************
procedure TfrmCRUDDiretor.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDDiretor.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDDiretor.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.LoadData
//************************************************************************
procedure TfrmCRUDDiretor.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TDiretor,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TDiretor(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDDiretor.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDDiretor.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDDiretor.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDDiretor.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDDiretor.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDDiretor.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDDiretor.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.ResizeGrid
//************************************************************************
procedure TfrmCRUDDiretor.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.FastSearch
//************************************************************************
procedure TfrmCRUDDiretor.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TDiretor,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDDiretor.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDDiretor.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDDiretor.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDDiretor.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDDiretor.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDDiretor.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.SetupPermissions
//************************************************************************
procedure TfrmCRUDDiretor.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDDiretor.SetupFilters
//************************************************************************
procedure TfrmCRUDDiretor.SetupFilters;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.List
//************************************************************************
procedure TfrmCRUDDiretor.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDDiretor.CanCreateObject
//************************************************************************
function  TfrmCRUDDiretor.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDDiretor.InitializeNewObject
//************************************************************************
procedure TfrmCRUDDiretor.InitializeNewObject(ANewObject: TDiretor);
...
//************************************************************************
//* TfrmCRUDDiretor.AfterInsert
//************************************************************************
procedure TfrmCRUDDiretor.AfterInsert(AObject: TDiretor);
...
//************************************************************************
//* TfrmCRUDDiretor.BeforeDelete
//************************************************************************
procedure TfrmCRUDDiretor.BeforeDelete(AObject: TDiretor);
...
begin
   ...
   begin
      ...
      NewObjectLog.Referencia:= 'Nome: '+AObject.NomeExibicao;
      NewObjectLog.Acao:='D';
   end;
...
//************************************************************************
//* TfrmCRUDDiretor.AfterDelete
//************************************************************************
procedure TfrmCRUDDiretor.AfterDelete;
...
//************************************************************************
//* TfrmCRUDDiretor.AfterEdit
//************************************************************************
procedure TfrmCRUDDiretor.AfterEdit(AObject: TDiretor);
...
//************************************************************************
//* TfrmCRUDDiretor.ShowSpinner
//************************************************************************
procedure TfrmCRUDDiretor.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDDiretor.HideSpinner
//************************************************************************
procedure TfrmCRUDDiretor.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDDiretor.VisibleChanging
//************************************************************************
procedure TfrmCRUDDiretor.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
