...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TFilme);
    ...
    procedure InitializeNewObject(ANewObject: TFilme);
    procedure AfterInsert(AObject: TFilme);
    procedure BeforeDelete(AObject: TFilme);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TFilme);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     ...
     public
        property Form: TfrmCRUDFilme read FForm write FForm;
...
//************************************************************************
//* TfrmCRUDFilme.FormCreate
//************************************************************************
procedure TfrmCRUDFilme.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDFilme.FormActivate
//************************************************************************
procedure TfrmCRUDFilme.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDFilme.FormDestroy
//************************************************************************
procedure TfrmCRUDFilme.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDFilme.FormResize
//************************************************************************
procedure TfrmCRUDFilme.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.FormClose
//************************************************************************
procedure TfrmCRUDFilme.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDFilme.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDFilme.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDFilme.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDFilme.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDFilme.cmdInsertClick
//************************************************************************
procedure TfrmCRUDFilme.cmdInsertClick(Sender: TObject);
...
begin
   ...
   NewObject:=TFilme.Create;
   InitializeNewObject(NewObject);
   // Create data form
   Application.CreateForm(TfrmDataFilme,frmDataFilme);
   DataForm:=frmDataFilme;
   Screen.Cursor:=crDefault;
   // Show data form
   r:=frmDataFilme.Open(TFilme(NewObject),True);
   if r then begin
      // Refresh
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDFilme.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDFilme.cmdDeleteClick(Sender: TObject);
var
   ObjectToDelete: TFilme;
   CanDelete: Boolean;
   Reason: string;
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TFilme.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TFilme;
...
//************************************************************************
//* TfrmCRUDFilme.cmdEditClick
//************************************************************************
procedure TfrmCRUDFilme.cmdEditClick(Sender: TObject);
...
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TFilme.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TFilme;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TFilme then begin
            Application.CreateForm(TfrmDataFilme,DataForm);
            try
               Screen.Cursor:=crDefault;
               // Show data form
               if DataForm.Open(TFilme(ObjectToEdit),False) then begin
                  Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDFilme.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDFilme.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDFilme.cmdListClick
//************************************************************************
procedure TfrmCRUDFilme.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDFilme.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDFilme.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDFilme.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDFilme.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDFilme.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDFilme.cmdSearchClick
//************************************************************************
procedure TfrmCRUDFilme.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDFilme',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDFilme.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDFilme.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDFilme.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDFilme.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDFilme.cmdCustomButtonsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.grdDataDblClick
//************************************************************************
procedure TfrmCRUDFilme.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDFilme.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDFilme.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDFilme.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDFilme.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDFilme.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDFilme.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDFilme.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDFilme.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDFilme.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDFilme.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDFilme.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDFilme.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDFilme.InitializeAvailableColumns;
...
begin
   ...
   AvailableColumn.PropertyName:='Nome';
   AvailableColumn.PropertyDescription:='Nome';
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='Sinopse';
   AvailableColumn.PropertyDescription:='Sinopse';
   AvailableColumn.PropertyType:=optString;
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='AnoLancamento';
   AvailableColumn.PropertyDescription:='Ano de Lançamento';
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='QuantidadeEstoque';
   AvailableColumn.PropertyDescription:='Quantidade em Estoque';
   AvailableColumn.PropertyType:=optInteger;
   AvailableColumn.PropertyFieldSize:=0;
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='QuantidadeReservada';
   AvailableColumn.PropertyDescription:='Quantidade Reservada';
   AvailableColumn.PropertyType:=optInteger;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=10;
   AvailableColumn.CanOrderBy:=True;
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='QuantidadeLocacao';
   AvailableColumn.PropertyDescription:='Quantidade em Locação';
   AvailableColumn.PropertyType:=optInteger;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=10;
   AvailableColumn.CanOrderBy:=True;
...
//************************************************************************
//* TfrmCRUDFilme.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDFilme.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDFilme.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDFilme.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDFilme.SetupGridColumns
//************************************************************************
procedure TfrmCRUDFilme.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDFilme.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDFilme.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDFilme.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDFilme.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDFilme.FillGridRow
//************************************************************************
procedure TfrmCRUDFilme.FillGridRow(ARow: Integer; AObject: TFilme);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//$$** SECTION: FILL_GRID_COLUMNS
         if AvailableColumn.PropertyName='Nome' then begin
            grdData.Cells[c,ARow]:=AObject.Nome;
         end else if AvailableColumn.PropertyName='Sinopse' then begin
            grdData.Cells[c,ARow]:=AObject.Sinopse;
         end else if AvailableColumn.PropertyName='AnoLancamento' then begin
            grdData.Cells[c,ARow]:=IntToStr(AObject.AnoLancamento);
         end else if AvailableColumn.PropertyName='QuantidadeEstoque' then begin
            grdData.Cells[c,ARow]:=IntToStr(AObject.QuantidadeEstoque);
         end else if AvailableColumn.PropertyName='QuantidadeReservada' then begin
            grdData.Cells[c,ARow]:=IntToStr(AObject.QuantidadeReservada);
         end else if AvailableColumn.PropertyName='QuantidadeLocacao' then begin
            grdData.Cells[c,ARow]:=IntToStr(AObject.QuantidadeLocacao);
         end;
//$$** ENDSECTION
         c:=c+1;
      end;
...
//************************************************************************
//* TfrmCRUDFilme.ClearGridRow
//************************************************************************
procedure TfrmCRUDFilme.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDFilme.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDFilme.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDFilme.LoadData
//************************************************************************
procedure TfrmCRUDFilme.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TFilme,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TFilme(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDFilme.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDFilme.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDFilme.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDFilme.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDFilme.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDFilme.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDFilme.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDFilme.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDFilme.ResizeGrid
//************************************************************************
procedure TfrmCRUDFilme.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDFilme.FastSearch
//************************************************************************
procedure TfrmCRUDFilme.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TFilme,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDFilme.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDFilme.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDFilme.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDFilme.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDFilme.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDFilme.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDFilme.SetupPermissions
//************************************************************************
procedure TfrmCRUDFilme.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDFilme.SetupFilters
//************************************************************************
procedure TfrmCRUDFilme.SetupFilters;
begin
...
//* TfrmCRUDFilme.List
//************************************************************************
procedure TfrmCRUDFilme.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDFilme.CanCreateObject
//************************************************************************
function  TfrmCRUDFilme.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDFilme.InitializeNewObject
//************************************************************************
procedure TfrmCRUDFilme.InitializeNewObject(ANewObject: TFilme);
...
//************************************************************************
//* TfrmCRUDFilme.AfterInsert
//************************************************************************
procedure TfrmCRUDFilme.AfterInsert(AObject: TFilme);
...
//************************************************************************
//* TfrmCRUDFilme.BeforeDelete
//************************************************************************
procedure TfrmCRUDFilme.BeforeDelete(AObject: TFilme);
...
begin
   ...
   NewObjectLog.Acao:='D';
   NewObjectLog.Tela:= 'F';
   NewObjectLog.Referencia:= 'Nome: '+AObject.Nome;
...
//************************************************************************
//* TfrmCRUDFilme.AfterDelete
//************************************************************************
procedure TfrmCRUDFilme.AfterDelete;
...
//************************************************************************
//* TfrmCRUDFilme.AfterEdit
//************************************************************************
procedure TfrmCRUDFilme.AfterEdit(AObject: TFilme);
...
//************************************************************************
//* TfrmCRUDFilme.ShowSpinner
//************************************************************************
procedure TfrmCRUDFilme.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDFilme.HideSpinner
//************************************************************************
procedure TfrmCRUDFilme.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDFilme.VisibleChanging
//************************************************************************
procedure TfrmCRUDFilme.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
