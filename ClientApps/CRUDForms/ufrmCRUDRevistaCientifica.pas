unit ufrmCRUDRevistaCientifica;
...
type
  ...
  TfrmCRUDRevistaCientifica = class(TForm)
...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TRevistaCientifica);
    ...
    procedure InitializeNewObject(ANewObject: TRevistaCientifica);
    procedure AfterInsert(AObject: TRevistaCientifica);
    procedure BeforeDelete(AObject: TRevistaCientifica);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TRevistaCientifica);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     protected
        FForm: TfrmCRUDRevistaCientifica;
        FPOIDToSelect: Integer;
     public
        property Form: TfrmCRUDRevistaCientifica read FForm write FForm;
...
var
   frmCRUDRevistaCientifica: TfrmCRUDRevistaCientifica;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FormCreate
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FormActivate
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FormDestroy
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FormResize
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FormClose
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDRevistaCientifica.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDRevistaCientifica.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDRevistaCientifica.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDRevistaCientifica.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdInsertClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdInsertClick(Sender: TObject);
//$$** SECTION: INSERTBUTTONCLICK_FULLIMPL
var
   NewObject: TRevistaCientifica;
   r: Boolean;
...
begin
   ...
   NewObject:=TRevistaCientifica.Create;
   InitializeNewObject(NewObject);
   // Create data form
   Application.CreateForm(TfrmDataRevistaCientifica,frmDataRevistaCientifica);
   DataForm:=frmDataRevistaCientifica;
   Screen.Cursor:=crDefault;
   // Show data form
   r:=frmDataRevistaCientifica.Open(TRevistaCientifica(NewObject),True);
   if r then begin
      // Refresh
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdDeleteClick(Sender: TObject);
var
   ObjectToDelete: TRevistaCientifica;
   CanDelete: Boolean;
   Reason: string;
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TRevistaCientifica.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TRevistaCientifica;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdEditClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdEditClick(Sender: TObject);
//$$** SECTION: EDITBUTTONCLICK_FULLIMPL
var
   ObjectToEdit: TRevistaCientifica;
   DataForm: TP2SBFClientDataForm;
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TRevistaCientifica.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TRevistaCientifica;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TRevistaCientifica then begin
            Application.CreateForm(TfrmDataRevistaCientifica,DataForm);
            try
               Screen.Cursor:=crDefault;
               // Show data form
               if DataForm.Open(TRevistaCientifica(ObjectToEdit),False) then begin
                  Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdListClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDRevistaCientifica.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdSearchClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDRevistaCientifica',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.cmdCustomButtonsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataDblClick
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDRevistaCientifica.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDRevistaCientifica.InitializeAvailableColumns;
...
begin
   ...
   AvailableColumn.PropertyName:='Titulo';
   AvailableColumn.PropertyDescription:='Título';
   AvailableColumn.PropertyType:=optString;
   AvailableColumn.PropertyFieldSize:=50;
   AvailableColumn.ColumnWidth:=50;
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='Periodicidade';
   AvailableColumn.PropertyDescription:='Periodicidade';
   AvailableColumn.PropertyType:=optInteger;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=49;
   AvailableColumn.CanOrderBy:=True;
   AvailableColumn.Visible:=True;
   FAvailableColumnList.Add(AvailableColumn);
end;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDRevistaCientifica.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SetupGridColumns
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDRevistaCientifica.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FillGridRow
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FillGridRow(ARow: Integer; AObject: TRevistaCientifica);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//$$** SECTION: FILL_GRID_COLUMNS
         if AvailableColumn.PropertyName='Titulo' then begin
            grdData.Cells[c,ARow]:=AObject.Titulo;
         end else if AvailableColumn.PropertyName='Periodicidade' then begin
            if AObject.Periodicidade=1 then begin
               grdData.Cells[c,ARow]:='Mensal';
            end else if AObject.Periodicidade=2 then begin
               grdData.Cells[c,ARow]:='Bimestral';
            end else if AObject.Periodicidade=6 then begin
               grdData.Cells[c,ARow]:='Semestral';
            end;
         end;
//$$** ENDSECTION
         c:=c+1;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.ClearGridRow
//************************************************************************
procedure TfrmCRUDRevistaCientifica.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDRevistaCientifica.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDRevistaCientifica.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.LoadData
//************************************************************************
procedure TfrmCRUDRevistaCientifica.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TRevistaCientifica,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TRevistaCientifica(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDRevistaCientifica.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDRevistaCientifica.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDRevistaCientifica.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDRevistaCientifica.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.ResizeGrid
//************************************************************************
procedure TfrmCRUDRevistaCientifica.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FastSearch
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TRevistaCientifica,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDRevistaCientifica.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SetupPermissions
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.SetupFilters
//************************************************************************
procedure TfrmCRUDRevistaCientifica.SetupFilters;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.List
//************************************************************************
procedure TfrmCRUDRevistaCientifica.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.CanCreateObject
//************************************************************************
function  TfrmCRUDRevistaCientifica.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.InitializeNewObject
//************************************************************************
procedure TfrmCRUDRevistaCientifica.InitializeNewObject(ANewObject: TRevistaCientifica);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.AfterInsert
//************************************************************************
procedure TfrmCRUDRevistaCientifica.AfterInsert(AObject: TRevistaCientifica);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.BeforeDelete
//************************************************************************
procedure TfrmCRUDRevistaCientifica.BeforeDelete(AObject: TRevistaCientifica);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.AfterDelete
//************************************************************************
procedure TfrmCRUDRevistaCientifica.AfterDelete;
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.AfterEdit
//************************************************************************
procedure TfrmCRUDRevistaCientifica.AfterEdit(AObject: TRevistaCientifica);
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.ShowSpinner
//************************************************************************
procedure TfrmCRUDRevistaCientifica.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDRevistaCientifica.HideSpinner
//************************************************************************
procedure TfrmCRUDRevistaCientifica.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDRevistaCientifica.VisibleChanging
//************************************************************************
procedure TfrmCRUDRevistaCientifica.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
