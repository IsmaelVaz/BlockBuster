...
type
  ...
  TfrmCRUDNotaDebito = class(TForm)
...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TNotaDebito);
    ...
    procedure InitializeNewObject(ANewObject: TNotaDebito);
    procedure AfterInsert(AObject: TNotaDebito);
    procedure BeforeDelete(AObject: TNotaDebito);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TNotaDebito);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     protected
        FForm: TfrmCRUDNotaDebito;
        FPOIDToSelect: Integer;
     public
        property Form: TfrmCRUDNotaDebito read FForm write FForm;
...
var
   frmCRUDNotaDebito: TfrmCRUDNotaDebito;
...
//************************************************************************
//* TfrmCRUDNotaDebito.FormCreate
//************************************************************************
procedure TfrmCRUDNotaDebito.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDNotaDebito.FormActivate
//************************************************************************
procedure TfrmCRUDNotaDebito.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDNotaDebito.FormDestroy
//************************************************************************
procedure TfrmCRUDNotaDebito.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDNotaDebito.FormResize
//************************************************************************
procedure TfrmCRUDNotaDebito.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.FormClose
//************************************************************************
procedure TfrmCRUDNotaDebito.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDNotaDebito.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDNotaDebito.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDNotaDebito.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDNotaDebito.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdInsertClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdInsertClick(Sender: TObject);
//$$** SECTION: INSERTBUTTONCLICK_FULLIMPL
var
   NewObject: TNotaDebito;
   r: Boolean;
...
begin
   ...
   NewObject:=TNotaDebito.Create;
   InitializeNewObject(NewObject);
   // Create data form
   Application.CreateForm(TfrmDataNotaDebito,frmDataNotaDebito);
   DataForm:=frmDataNotaDebito;
   Screen.Cursor:=crDefault;
   // Show data form
   r:=frmDataNotaDebito.Open(TNotaDebito(NewObject),True);
   if r then begin
      // Refresh
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdDeleteClick(Sender: TObject);
var
   ObjectToDelete: TNotaDebito;
   CanDelete: Boolean;
   Reason: string;
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TNotaDebito.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TNotaDebito;
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdEditClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdEditClick(Sender: TObject);
//$$** SECTION: EDITBUTTONCLICK_FULLIMPL
var
   ObjectToEdit: TNotaDebito;
   DataForm: TP2SBFClientDataForm;
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TNotaDebito.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TNotaDebito;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TNotaDebito then begin
            Application.CreateForm(TfrmDataNotaDebito,DataForm);
            try
               Screen.Cursor:=crDefault;
               // Show data form
               if DataForm.Open(TNotaDebito(ObjectToEdit),False) then begin
                  Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdListClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDNotaDebito.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDNotaDebito.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDNotaDebito.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDNotaDebito.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdSearchClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDNotaDebito',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDNotaDebito.cmdCustomButtonsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataDblClick
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDNotaDebito.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDNotaDebito.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDNotaDebito.InitializeAvailableColumns;
...
begin
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='Descricao';
   AvailableColumn.PropertyDescription:='Descrição';
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='Locacao';
   AvailableColumn.PropertyDescription:='Locação';
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='ValorTotal';
   AvailableColumn.PropertyDescription:='Valor Total';
...
//************************************************************************
//* TfrmCRUDNotaDebito.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDNotaDebito.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDNotaDebito.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDNotaDebito.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.SetupGridColumns
//************************************************************************
procedure TfrmCRUDNotaDebito.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDNotaDebito.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDNotaDebito.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDNotaDebito.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDNotaDebito.FillGridRow
//************************************************************************
procedure TfrmCRUDNotaDebito.FillGridRow(ARow: Integer; AObject: TNotaDebito);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//$$** SECTION: FILL_GRID_COLUMNS
         ...
         end else if AvailableColumn.PropertyName='Descricao' then begin
            grdData.Cells[c,ARow]:=AObject.Descricao;
         end else if AvailableColumn.PropertyName='Locacao' then begin
            if AObject.Locacao.OIDRef.ID<>0 then begin
               grdData.Cells[c,ARow]:=TLocacao(TLocacao.Retrieve(AObject.Locacao.OIDRef)).NumeroRef;
            end else begin
               grdData.Cells[c,ARow]:='';
            end;
         end else if AvailableColumn.PropertyName='ValorTotal' then begin
            grdData.Cells[c,ARow]:=Format('%.2n',[AObject.ValorTotal]);
         end;
//$$** ENDSECTION
         c:=c+1;
      end;
...
//************************************************************************
//* TfrmCRUDNotaDebito.ClearGridRow
//************************************************************************
procedure TfrmCRUDNotaDebito.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDNotaDebito.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDNotaDebito.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.LoadData
//************************************************************************
procedure TfrmCRUDNotaDebito.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TNotaDebito,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
...
//$$** SECTION: FILL_OIDARRAYTOLOAD
            if TNotaDebito(ResultSet.Items[i]).Locacao.OIDRef.ID<>0 then begin
               _AddOIDToLoad(TNotaDebito(ResultSet.Items[i]).Locacao.OIDRef);
            end;
//$$** ENDSECTION
            end;
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TNotaDebito(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDNotaDebito.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDNotaDebito.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDNotaDebito.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDNotaDebito.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDNotaDebito.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDNotaDebito.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.ResizeGrid
//************************************************************************
procedure TfrmCRUDNotaDebito.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.FastSearch
//************************************************************************
procedure TfrmCRUDNotaDebito.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TNotaDebito,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDNotaDebito.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDNotaDebito.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDNotaDebito.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.SetupPermissions
//************************************************************************
procedure TfrmCRUDNotaDebito.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDNotaDebito.SetupFilters
//************************************************************************
procedure TfrmCRUDNotaDebito.SetupFilters;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.List
//************************************************************************
procedure TfrmCRUDNotaDebito.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDNotaDebito.CanCreateObject
//************************************************************************
function  TfrmCRUDNotaDebito.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDNotaDebito.InitializeNewObject
//************************************************************************
procedure TfrmCRUDNotaDebito.InitializeNewObject(ANewObject: TNotaDebito);
...
//************************************************************************
//* TfrmCRUDNotaDebito.AfterInsert
//************************************************************************
procedure TfrmCRUDNotaDebito.AfterInsert(AObject: TNotaDebito);
...
//************************************************************************
//* TfrmCRUDNotaDebito.BeforeDelete
//************************************************************************
procedure TfrmCRUDNotaDebito.BeforeDelete(AObject: TNotaDebito);
...
//************************************************************************
//* TfrmCRUDNotaDebito.AfterDelete
//************************************************************************
procedure TfrmCRUDNotaDebito.AfterDelete;
...
//************************************************************************
//* TfrmCRUDNotaDebito.AfterEdit
//************************************************************************
procedure TfrmCRUDNotaDebito.AfterEdit(AObject: TNotaDebito);
...
//************************************************************************
//* TfrmCRUDNotaDebito.ShowSpinner
//************************************************************************
procedure TfrmCRUDNotaDebito.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDNotaDebito.HideSpinner
//************************************************************************
procedure TfrmCRUDNotaDebito.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDNotaDebito.VisibleChanging
//************************************************************************
procedure TfrmCRUDNotaDebito.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
