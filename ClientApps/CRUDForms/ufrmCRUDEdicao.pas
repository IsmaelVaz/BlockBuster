...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TEdicao);
    ...
    procedure InitializeNewObject(ANewObject: TEdicao);
    procedure AfterInsert(AObject: TEdicao);
    procedure BeforeDelete(AObject: TEdicao);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TEdicao);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     protected
        FForm: TfrmCRUDEdicao;
        FPOIDToSelect: Integer;
     public
        property Form: TfrmCRUDEdicao read FForm write FForm;
...
//************************************************************************
//* TfrmCRUDEdicao.FormCreate
//************************************************************************
procedure TfrmCRUDEdicao.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDEdicao.FormActivate
//************************************************************************
procedure TfrmCRUDEdicao.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDEdicao.FormDestroy
//************************************************************************
procedure TfrmCRUDEdicao.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDEdicao.FormResize
//************************************************************************
procedure TfrmCRUDEdicao.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.FormClose
//************************************************************************
procedure TfrmCRUDEdicao.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDEdicao.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDEdicao.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDEdicao.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDEdicao.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.cmdInsertClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdInsertClick(Sender: TObject);
...
begin
   ...
   // Create data form
   Application.CreateForm(TfrmDataEdicao,frmDataEdicao);
   DataForm:=frmDataEdicao;
   Screen.Cursor:=crDefault;
   // Show data form
   r:=frmDataEdicao.Open(TEdicao(NewObject),True);
   if r then begin
      // Refresh
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDEdicao.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdDeleteClick(Sender: TObject);
var
...
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TEdicao.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TEdicao;
...
//************************************************************************
//* TfrmCRUDEdicao.cmdEditClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdEditClick(Sender: TObject);
...
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TEdicao.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TEdicao;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TEdicao then begin
            Application.CreateForm(TfrmDataEdicao,DataForm);
            try
               Screen.Cursor:=crDefault;
               // Show data form
               if DataForm.Open(TEdicao(ObjectToEdit),False) then begin
                  Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDEdicao.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDEdicao.cmdListClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDEdicao.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDEdicao.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDEdicao.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDEdicao.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDEdicao.cmdSearchClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDEdicao',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDEdicao.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDEdicao.cmdCustomButtonsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataDblClick
//************************************************************************
procedure TfrmCRUDEdicao.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDEdicao.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDEdicao.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDEdicao.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDEdicao.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDEdicao.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDEdicao.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDEdicao.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDEdicao.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDEdicao.InitializeAvailableColumns;
...
//************************************************************************
//* TfrmCRUDEdicao.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDEdicao.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDEdicao.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDEdicao.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDEdicao.SetupGridColumns
//************************************************************************
procedure TfrmCRUDEdicao.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDEdicao.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDEdicao.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDEdicao.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDEdicao.FillGridRow
//************************************************************************
procedure TfrmCRUDEdicao.FillGridRow(ARow: Integer; AObject: TEdicao);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//************************************************************************
//* TfrmCRUDEdicao.ClearGridRow
//************************************************************************
procedure TfrmCRUDEdicao.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDEdicao.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDEdicao.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.LoadData
//************************************************************************
procedure TfrmCRUDEdicao.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TEdicao,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TEdicao(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDEdicao.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDEdicao.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDEdicao.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDEdicao.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDEdicao.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDEdicao.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDEdicao.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.ResizeGrid
//************************************************************************
procedure TfrmCRUDEdicao.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.FastSearch
//************************************************************************
procedure TfrmCRUDEdicao.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TEdicao,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDEdicao.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDEdicao.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDEdicao.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDEdicao.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDEdicao.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDEdicao.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.SetupPermissions
//************************************************************************
procedure TfrmCRUDEdicao.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDEdicao.SetupFilters
//************************************************************************
procedure TfrmCRUDEdicao.SetupFilters;
begin
...
//* TfrmCRUDEdicao.List
//************************************************************************
procedure TfrmCRUDEdicao.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDEdicao.CanCreateObject
//************************************************************************
function  TfrmCRUDEdicao.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDEdicao.InitializeNewObject
//************************************************************************
procedure TfrmCRUDEdicao.InitializeNewObject(ANewObject: TEdicao);
...
//************************************************************************
//* TfrmCRUDEdicao.AfterInsert
//************************************************************************
procedure TfrmCRUDEdicao.AfterInsert(AObject: TEdicao);
...
//************************************************************************
//* TfrmCRUDEdicao.BeforeDelete
//************************************************************************
procedure TfrmCRUDEdicao.BeforeDelete(AObject: TEdicao);
...
//************************************************************************
//* TfrmCRUDEdicao.AfterDelete
//************************************************************************
procedure TfrmCRUDEdicao.AfterDelete;
...
//************************************************************************
//* TfrmCRUDEdicao.AfterEdit
//************************************************************************
procedure TfrmCRUDEdicao.AfterEdit(AObject: TEdicao);
...
//************************************************************************
//* TfrmCRUDEdicao.ShowSpinner
//************************************************************************
procedure TfrmCRUDEdicao.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDEdicao.HideSpinner
//************************************************************************
procedure TfrmCRUDEdicao.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDEdicao.VisibleChanging
//************************************************************************
procedure TfrmCRUDEdicao.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
