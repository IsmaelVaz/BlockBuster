...
//$$** ENDSECTION
    ...
    procedure FillGridRow(ARow: Integer; AObject: TLocacao);
    ...
    procedure InitializeNewObject(ANewObject: TLocacao);
    procedure AfterInsert(AObject: TLocacao);
    procedure BeforeDelete(AObject: TLocacao);
    procedure AfterDelete;
    procedure AfterEdit(AObject: TLocacao);
...
//$$** ENDSECTION
  ...
  TRefreshThread = class(TThread)
     protected
        FForm: TfrmCRUDLocacao;
        FPOIDToSelect: Integer;
     public
        property Form: TfrmCRUDLocacao read FForm write FForm;
...
var
   frmCRUDLocacao: TfrmCRUDLocacao;
...
//************************************************************************
//* TfrmCRUDLocacao.FormCreate
//************************************************************************
procedure TfrmCRUDLocacao.FormCreate(Sender: TObject);
begin
   FDestroying:=False;
   FFirstActivate:=True;
   FFlagLoading:=False;
...
//************************************************************************
//* TfrmCRUDLocacao.FormActivate
//************************************************************************
procedure TfrmCRUDLocacao.FormActivate(Sender: TObject);
...
//************************************************************************
//* TfrmCRUDLocacao.FormDestroy
//************************************************************************
procedure TfrmCRUDLocacao.FormDestroy(Sender: TObject);
begin
   FDestroying:=True;
...
//************************************************************************
//* TfrmCRUDLocacao.FormResize
//************************************************************************
procedure TfrmCRUDLocacao.FormResize(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.FormClose
//************************************************************************
procedure TfrmCRUDLocacao.FormClose(Sender: TObject;
...
{
//************************************************************************
//* TfrmCRUDLocacao.tmrColWidthsTimer
//************************************************************************
procedure TfrmCRUDLocacao.tmrColWidthsTimer(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.txtFastSearchChange
//************************************************************************
procedure TfrmCRUDLocacao.txtFastSearchChange(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.txtFastSearchKeyPress
//************************************************************************
procedure TfrmCRUDLocacao.txtFastSearchKeyPress(Sender: TObject; var Key: Char);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.cmdInsertClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdInsertClick(Sender: TObject);
...
begin
   ...
   NewObject:=TLocacao.Create;
   InitializeNewObject(NewObject);
   // Create data form
   Application.CreateForm(TfrmDataLocacao,frmDataLocacao);
   DataForm:=frmDataLocacao;
   Screen.Cursor:=crDefault;
   // Show data form
   r:=frmDataLocacao.Open(TLocacao(NewObject),True);
   if r then begin
      // Refresh
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDLocacao.cmdDeleteClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdDeleteClick(Sender: TObject);
var
   ObjectToDelete: TLocacao;
   CanDelete: Boolean;
   Reason: string;
begin
   if High(FArrayId)>=0 then begin
      Screen.Cursor:=crHourglass;
      ObjectToDelete:=TLocacao.Retrieve(POID(FArrayId[grdData.Row-1]),False) as TLocacao;
...
//************************************************************************
//* TfrmCRUDLocacao.cmdEditClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdEditClick(Sender: TObject);
//$$** SECTION: EDITBUTTONCLICK_FULLIMPL
var
   ObjectToEdit: TLocacao;
   DataForm: TP2SBFClientDataForm;
begin
   if cmdEdit.Visible then begin
      if High(FArrayId)>=0 then begin
         ...
         Screen.Cursor:=crHourglass;
         try
            ObjectToEdit:=TLocacao.Retrieve(POID(FArrayId[grdData.Row-1]),True) as TLocacao;
         except
            Screen.Cursor:=crDefault;
            Application.MessageBox(PChar('O registro selecionado não foi encontrado.'+#13#10+'Verifique se ele não foi excluído por outro usuário na rede.'+#13#10+'Clique no botão "Atualizar" para recarregar os dados.'),'Erro',MB_ICONEXCLAMATION);
            Exit;
         end;
         if ObjectToEdit is TLocacao then begin
            Application.CreateForm(TfrmDataLocacao,DataForm);
            try
               Screen.Cursor:=crDefault;
               // Show data form
               if DataForm.Open(TLocacao(ObjectToEdit),False) then begin
                  Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDLocacao.cmdRefreshClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdRefreshClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDLocacao.cmdListClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdListClick(Sender: TObject);
begin
   cmdList.CheckMenuDropDown;
end;

//************************************************************************
//* TfrmCRUDLocacao.mnuListPortraitClick
//************************************************************************
procedure TfrmCRUDLocacao.mnuListPortraitClick(
  Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.mnuListLandscapeClick
//************************************************************************
procedure TfrmCRUDLocacao.mnuListLandscapeClick(Sender: TObject);
begin
   Self.List(poLandscape);
end;

//************************************************************************
//* TfrmCRUDLocacao.cmdExportToExcelClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdExportToExcelClick(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDLocacao.cmdSearchClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdSearchClick(Sender: TObject);
var
   SelectedID: Integer;
begin
   Screen.Cursor:=crHourglass;
   ...
   if frmGeneralSearch.Open('frmCRUDLocacao',FCriteriaList,FCriteriaListDesc) then begin
      Screen.Cursor:=crHourglass;
...
//************************************************************************
//* TfrmCRUDLocacao.cmdCancelSearchClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdCancelSearchClick(Sender: TObject);
var
   i: Integer;
   SelectedID: Integer;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.cmdSelectColumnsClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdSelectColumnsClick(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.cmdCustomButtonsClick
//************************************************************************
procedure TfrmCRUDLocacao.cmdCustomButtonsClick(Sender: TObject);
begin
   cmdCustomButtons.CheckMenuDropdown;
end;

//************************************************************************
//* TfrmCRUDLocacao.mnuCustomButton1Click
//************************************************************************
procedure TfrmCRUDLocacao.mnuCustomButton1Click(Sender: TObject);
      ...
      try
         ...
         if ObjetoParaFaturar <> nil then begin
            if ObjetoParafaturar.StatusLocacao <> 'P' then begin
               ...
               if ValorParaFaturar > 0 then begin
                  if Application.MessageBox(PChar('Confirma o faturamento da locação '+IntToStr(ObjetoParaFaturar.Numero)+'?'),'Confirmação',MB_ICONQUESTION+MB_OKCANCEL)=IDOK then begin

                     ObjetoParaFaturar.FaturarLocacao(Date, ValorParaFaturar);
                     ObjetoParaFaturar.GetArrayNotaDebito(ArrayNotaDebito, 'DESC');

                     NotaDebitoAux:= TNotaDebito(ArrayNotaDebito[0]);

                     Application.MessageBox(PChar('Nota de Débito '+IntToStr(NotaDebitoAux.Numero)+' gerada com sucesso '),'Aviso');
                  end;
               end else begin
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataDblClick
//************************************************************************
procedure TfrmCRUDLocacao.grdDataDblClick(Sender: TObject);
begin
   cmdEditClick(Self);
end;

//************************************************************************
//* TfrmCRUDLocacao.grdDataDrawCell
//************************************************************************
procedure TfrmCRUDLocacao.grdDataDrawCell(Sender: TObject; ACol,
                       ARow: Integer; Rect: TRect; State: TGridDrawState);
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataMouseMove
//************************************************************************
procedure TfrmCRUDLocacao.grdDataMouseMove(Sender: TObject;
  Shift: TShiftState; X, Y: Integer);
var
   i,c: Integer;
   Col,Row: Integer;
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataMouseUp
//************************************************************************
procedure TfrmCRUDLocacao.grdDataMouseUp(Sender: TObject;
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataTopLeftChanged
//************************************************************************
procedure TfrmCRUDLocacao.grdDataTopLeftChanged(Sender: TObject);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataTopLeftChangedOnBackground
//************************************************************************
procedure TfrmCRUDLocacao.grdDataTopLeftChangedOnBackground(Sender: TObject);
var
...
//************************************************************************
//* TfrmCRUDLocacao.grdDataTopLeftChangedOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDLocacao.grdDataTopLeftChangedOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.InitializeAvailableColumns
//************************************************************************
procedure TfrmCRUDLocacao.InitializeAvailableColumns;
...
begin
   ...
   AvailableColumn.PropertyName:='Numero';
   AvailableColumn.PropertyDescription:='Número';
   AvailableColumn.PropertyType:=optInteger;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=5;
   AvailableColumn.CanOrderBy:=True;
   AvailableColumn.Visible:=True;
   FAvailableColumnList.Add(AvailableColumn);
   SetOrderByColumn(AvailableColumn,'DESC');

   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='Socio';
   AvailableColumn.PropertyDescription:='Sócio';
   AvailableColumn.PropertyType:=optObject;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=20;
   AvailableColumn.CanOrderBy:=False;
   AvailableColumn.Visible:=True;
   FAvailableColumnList.Add(AvailableColumn);

   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='StatusLocacao';
   AvailableColumn.PropertyDescription:='Status';
   AvailableColumn.PropertyType:=optString;
   AvailableColumn.PropertyFieldSize:=1;
   AvailableColumn.ColumnWidth:=15;
   AvailableColumn.CanOrderBy:=False;
   AvailableColumn.Visible:=True;
   FAvailableColumnList.Add(AvailableColumn);

   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='DataInicial';
   AvailableColumn.PropertyDescription:='Data Inicial';
   AvailableColumn.PropertyType:=optDouble;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=10;
   AvailableColumn.CanOrderBy:=True;
   AvailableColumn.Visible:=True;
   FAvailableColumnList.Add(AvailableColumn);

   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='DataFinal';
   AvailableColumn.PropertyDescription:='DataFinal';
   AvailableColumn.PropertyType:=optDouble;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=10;
   AvailableColumn.CanOrderBy:=True;
   ...
   AvailableColumn:=TCRUDFormAvailableColumn.Create;
   AvailableColumn.PropertyName:='ValorFinal';
   AvailableColumn.PropertyDescription:='Valor Final';
   AvailableColumn.PropertyType:=optDouble;
   AvailableColumn.PropertyFieldSize:=0;
   AvailableColumn.ColumnWidth:=20;
   AvailableColumn.CanOrderBy:=True;
...
//************************************************************************
//* TfrmCRUDLocacao.LoadConfigAvailableColumns
//************************************************************************
procedure TfrmCRUDLocacao.LoadConfigAvailableColumns;
var
   i: Integer;
...
//************************************************************************
//* TfrmCRUDLocacao.SetOrderByColumn
//************************************************************************
procedure TfrmCRUDLocacao.SetOrderByColumn(AColumn: TCRUDFormAvailableColumn; ADirection: string = '');
begin
...
//************************************************************************
//* TfrmCRUDLocacao.SetupGridColumns
//************************************************************************
procedure TfrmCRUDLocacao.SetupGridColumns;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.SetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDLocacao.SetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
var
   i: Integer;
   Id: Integer;
...
//************************************************************************
//* TfrmCRUDLocacao.CustomSetupFinalCriteriaList
//************************************************************************
procedure TfrmCRUDLocacao.CustomSetupFinalCriteriaList(AFinalCriteriaList: TP2SBFCriteriaList);
...
//************************************************************************
//* TfrmCRUDLocacao.FillGridRow
//************************************************************************
procedure TfrmCRUDLocacao.FillGridRow(ARow: Integer; AObject: TLocacao);
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
...
//$$** SECTION: FILL_GRID_COLUMNS
         if AvailableColumn.PropertyName='Numero' then begin
            grdData.Cells[c,ARow]:=IntToStr(AObject.Numero);
         end else if AvailableColumn.PropertyName='Socio' then begin
            if AObject.Socio.OIDRef.ID<>0 then begin
               grdData.Cells[c,ARow]:=TSocio(TSocio.Retrieve(AObject.Socio.OIDRef)).NomeExibicao;
            end else begin
               grdData.Cells[c,ARow]:='';
            end;
         end else if AvailableColumn.PropertyName='StatusLocacao' then begin
            if AObject.StatusLocacao='P' then begin
               grdData.Cells[c,ARow]:='Em Preparação';
            end else if AObject.StatusLocacao='A' then begin
               grdData.Cells[c,ARow]:='Aprovado';
            end else if AObject.StatusLocacao='L' then begin
               grdData.Cells[c,ARow]:='Em Locação';
            end else if AObject.StatusLocacao='F' then begin
               grdData.Cells[c,ARow]:='Finalizado';
            end;
         end else if AvailableColumn.PropertyName='DataInicial' then begin
            if AObject.DataInicial<>0.0 then begin
               grdData.Cells[c,ARow]:=FormatDateTime('dd/mm/yyyy',AObject.DataInicial);
            end else begin
               grdData.Cells[c,ARow]:='';
            end;
         end else if AvailableColumn.PropertyName='DataFinal' then begin
            if AObject.DataFinal<>0.0 then begin
               grdData.Cells[c,ARow]:=FormatDateTime('dd/mm/yyyy',AObject.DataFinal);
            end else begin
               grdData.Cells[c,ARow]:='';
            end;
         end else if AvailableColumn.PropertyName='ValorFinal' then begin
            grdData.Cells[c,ARow]:=Format('%.2n',[AObject.ValorFinal]);
         end;
//$$** ENDSECTION
         c:=c+1;
      end;
...
//************************************************************************
//* TfrmCRUDLocacao.ClearGridRow
//************************************************************************
procedure TfrmCRUDLocacao.ClearGridRow(ARow: Integer);
var
   i: Integer;
begin
   for i:=0 to grdData.ColCount-1 do begin
...
//************************************************************************
//*TfrmCRUDLocacao.GetGridVisibleRange
//************************************************************************
procedure TfrmCRUDLocacao.GetGridVisibleRange(var AStartRow: Integer; var AEndRow: Integer; var AFlagLoad: Boolean);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.LoadData
//************************************************************************
procedure TfrmCRUDLocacao.LoadData(APOIDToSelect: Integer; AFullLoad: Boolean; ALimitOffset: Integer; ALimitCount: Integer; ASetOthersAsNotLoaded: Boolean);
var
   i,Id: Integer;
   ResultSet: TList;
...
begin
   ...
   try
      ...
      try
         ...
         RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TLocacao,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,LimitOffset,LimitCount,0,0,QueryResultOIDList);
         if AFullLoad then begin
...
//$$** SECTION: FILL_OIDARRAYTOLOAD
            if TLocacao(ResultSet.Items[i]).Socio.OIDRef.ID<>0 then begin
               _AddOIDToLoad(TLocacao(ResultSet.Items[i]).Socio.OIDRef);
            end;
//$$** ENDSECTION
            end;
            ...
            if AFullLoad or ASetOthersAsNotLoaded then begin
               for i:=0 to RecCount-1 do begin
                  if ((i>=LimitOffset) and (i<=LimitOffset+LimitCount-1)) then begin
                     ...
                     FArrayLoaded[i]:=True;
                     FillGridRow(i+1,TLocacao(ResultSet.Items[i-LimitOffset]));
                  end else begin
                     FArrayId[i]:=0;
...
//************************************************************************
//* TfrmCRUDLocacao.RefreshVisibleRange
//************************************************************************
procedure TfrmCRUDLocacao.RefreshVisibleRange(APOIDToSelect: Integer = 0);
var
   b1,b2: Integer;
   FlagLoad: Boolean;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.RefreshVisibleRangeOnBackground
//************************************************************************
procedure TfrmCRUDLocacao.RefreshVisibleRangeOnBackground(APOIDToSelect: Integer = 0);
var
...
//************************************************************************
//* TfrmCRUDLocacao.RefreshVisibleRangeOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDLocacao.RefreshVisibleRangeOnBackgroundTerminate(Sender: TObject);
begin
   HideSpinner;
   grdData.Visible:=True;
   Self.Enabled:=True;
...
//************************************************************************
//* TfrmCRUDLocacao.UpdateInternalColumnWidths
//************************************************************************
procedure TfrmCRUDLocacao.UpdateInternalColumnWidths;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.ResizeGrid
//************************************************************************
procedure TfrmCRUDLocacao.ResizeGrid;
var
   i,c: Integer;
   AvailableColumn: TCRUDFormAvailableColumn;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.FastSearch
//************************************************************************
procedure TfrmCRUDLocacao.FastSearch(AText: string);
...
begin
   ...
   try
      ...
      RecCount:=gP2SBFObjRepos.QueryPersistentObjects(TLocacao,FinalCriteriaList,ResultSet,FOrderByPropertyName+' '+FOrderByDirection,False,False,0,1);
   finally
      ResultSet.Free;
      // Free final criteria list
      for i:=0 to FinalCriteriaList.Count-1 do begin
...
//************************************************************************
//* TfrmCRUDLocacao.FastSearchOnBackground
//************************************************************************
procedure TfrmCRUDLocacao.FastSearchOnBackground(AText: string);
var
...
//************************************************************************
//* TfrmCRUDLocacao.FastSearchOnBackgroundTerminate
//************************************************************************
procedure TfrmCRUDLocacao.FastSearchOnBackgroundTerminate(Sender: TObject);
begin
...
//************************************************************************
//* TfrmCRUDLocacao.SelectRowByPOID
//************************************************************************
procedure TfrmCRUDLocacao.SelectRowByPOID(APOID: Integer);
var
   i: Integer;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.SetupPermissions
//************************************************************************
procedure TfrmCRUDLocacao.SetupPermissions;
var
...
//************************************************************************
//* TfrmCRUDLocacao.List
//************************************************************************
procedure TfrmCRUDLocacao.List(AOrientation: TPrinterOrientation);
...
//************************************************************************
//* TfrmCRUDLocacao.CanCreateObject
//************************************************************************
function  TfrmCRUDLocacao.CanCreateObject: Boolean;
...
//************************************************************************
//* TfrmCRUDLocacao.InitializeNewObject
//************************************************************************
procedure TfrmCRUDLocacao.InitializeNewObject(ANewObject: TLocacao);
...
//************************************************************************
//* TfrmCRUDLocacao.AfterInsert
//************************************************************************
procedure TfrmCRUDLocacao.AfterInsert(AObject: TLocacao);
...
//************************************************************************
//* TfrmCRUDLocacao.BeforeDelete
//************************************************************************
procedure TfrmCRUDLocacao.BeforeDelete(AObject: TLocacao);
...
//************************************************************************
//* TfrmCRUDLocacao.AfterDelete
//************************************************************************
procedure TfrmCRUDLocacao.AfterDelete;
...
//************************************************************************
//* TfrmCRUDLocacao.AfterEdit
//************************************************************************
procedure TfrmCRUDLocacao.AfterEdit(AObject: TLocacao);
...
//************************************************************************
//* TfrmCRUDLocacao.ShowSpinner
//************************************************************************
procedure TfrmCRUDLocacao.ShowSpinner;
begin
...
//************************************************************************
//* TfrmCRUDLocacao.HideSpinner
//************************************************************************
procedure TfrmCRUDLocacao.HideSpinner;
begin
...
(*
//************************************************************************
//* TfrmCRUDLocacao.VisibleChanging
//************************************************************************
procedure TfrmCRUDLocacao.VisibleChanging;
begin
  {if Visible then
    FormStyle := fsNormal
  else
